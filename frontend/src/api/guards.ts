...
export function parseHealth(json: unknown): HealthResponse {
  ...
  const runtime: ModelRuntimeInfo = {
    ...
    runtime_mode: typeof m.runtime_mode === "string" ? m.runtime_mode : undefined,
    serving: isRecord(m.serving) && typeof m.serving.state === "string" ? { state: m.serving.state } : undefined,
    parallel_slots: typeof m.parallel_slots === "number" ? m.parallel_slots : undefined,
