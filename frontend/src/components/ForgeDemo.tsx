...
export function ForgeDemo() {
  ...
  return (
    <figure className="forge-demo" aria-label="Example: a question turned into SQL and a result, captured from a real run">
      <div className="forge-window">
        ...
        <div className="forge-step">
          <span className="forge-tag tag-sql">SQL · generated by the model</span>
